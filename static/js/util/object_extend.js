...
define(function() {
  var isArray, isDate, isFunction, isNumber, isObject, isString, keyPath, magicReplace, normalReplace, replace;
  ...
  normalReplace = function(template, replacement) {
  ...
  magicReplace = function(template, replacement) {};
  return {
    'isNumber': isNumber,
    'isObject': isObject,
    'isArray': isArray,
